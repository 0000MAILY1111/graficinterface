           ...
           <div className="flex min-h-screen flex-col items-center justify-center bg-white ">
              <div className="w-full max-w-sm space-y-6 ">
                ...
                <form className="space-x-4 "> 
                    ...
                    <button className="w-full rounded-md bg-black text-sm text-white  py-2 font-medium hover:bg-gray-500 focus:outline-none disable:cursor-not-allowed disabled:bg-gray-300  ">
                        Register 
                    </button>
